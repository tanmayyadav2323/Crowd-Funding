import {
  ...
  state,
  svg
} from "./chunk-2PWZ5AQD.js";
import {
  require_browser
} from "./chunk-XVE7NE4Y.js";
import {
  C,
  H,
  K,
...
var ke = (t, e, a) => e in t ? Fe(t, e, { enumerable: true, configurable: true, writable: true, value: a }) : t[e] = a;
var jt = (t, e) => {
  for (var a in e || (e = {}))
    qe.call(e, a) && ke(t, a, e[a]);
  if ($e)
    for (var a of $e(e))
...
var Xe = css`button{display:flex;border-radius:var(--w3m-button-hover-highlight-border-radius);flex-direction:column;justify-content:center;padding:5px;width:100px}button:active{background-color:var(--w3m-color-overlay)}@media(hover:hover){button:hover{background-color:var(--w3m-color-overlay)}}button>div{display:flex;justify-content:center;align-items:center;width:32px;height:32px;box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);background-color:var(--w3m-accent-color);border-radius:var(--w3m-icon-button-border-radius);margin-bottom:4px}button path{fill:var(--w3m-accent-fill-color)}`;
var Je = Object.defineProperty;
var to = Object.getOwnPropertyDescriptor;
var Mt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? to(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
z.styles = [w.globalCss, eo], nt([property()], z.prototype, "disabled", 2), nt([property()], z.prototype, "iconLeft", 2), nt([property()], z.prototype, "iconRight", 2), nt([property()], z.prototype, "onClick", 2), nt([property()], z.prototype, "variant", 2), z = nt([customElement("w3m-button")], z);
var ro = css`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--w3m-button-border-radius);color:var(--w3m-accent-fill-color);background-color:var(--w3m-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--w3m-color-overlay)}button:active::after{background-color:var(--w3m-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--w3m-color-bg-3);color:var(--w3m-color-fg-3)}.w3m-secondary{color:var(--w3m-accent-color);background-color:transparent}.w3m-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--w3m-color-overlay)}}`;
var lo = Object.defineProperty;
var io = Object.getOwnPropertyDescriptor;
var qt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? io(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
vt.styles = [w.globalCss, ro], qt([property()], vt.prototype, "disabled", 2), qt([property()], vt.prototype, "variant", 2), vt = qt([customElement("w3m-button-big")], vt);
var no = css`:host{background-color:var(--w3m-color-bg-2);border-top:1px solid var(--w3m-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var so = Object.defineProperty;
var co = Object.getOwnPropertyDescriptor;
var mo = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? co(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Pt = class extends LitElement {
  ...
  logoTemplate() {
    ...
    return e ? html`<img src="${e}">` : h.WALLET_CONNECT_LOGO;
  }
  render() {
    const t = { "w3m-help-active": this.isHelp };
    return html`<div class="w3m-toolbar-placeholder"></div><div class="w3m-toolbar">${this.logoTemplate()}<div class="${classMap(t)}"><button @click="${this.onHelp}">${h.HELP_ICON}</button> <button @click="${se.close}">${h.CROSS_ICON}</button></div></div>`;
  }
};
Pt.styles = [w.globalCss, ho], Ie([state()], Pt.prototype, "isHelp", 2), Pt = Ie([customElement("w3m-modal-backcard")], Pt);
var go = css`main{padding:20px;padding-top:0;width:100%}`;
var uo = Object.defineProperty;
var vo = Object.getOwnPropertyDescriptor;
var bo = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? vo(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
Yt.styles = [w.globalCss, go], Yt = bo([customElement("w3m-modal-content")], Yt);
var fo = css`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--w3m-color-bg-2)}`;
var xo = Object.defineProperty;
var yo = Object.getOwnPropertyDescriptor;
var Co = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? yo(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Y = class extends LitElement {
  ...
  backBtnTemplate() {
    return html`<button class="w3m-back-btn" @click="${b.goBack}">${h.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
...
var Z = { externalWallets() {
  ...
  var t, e;
  const { mobileWallets: a, desktopWallets: r } = y.state, o = (t = Z.recentWallet()) == null ? void 0 : t.id, l = c.isMobile() ? a : r, i = l == null ? void 0 : l.filter((p) => o !== p.id);
  return (e = c.isMobile() ? i == null ? void 0 : i.map(({ id: p, name: g, links: f }) => ({ id: p, name: g, mobile: f, links: f })) : i == null ? void 0 : i.map(({ id: p, name: g, links: f }) => ({ id: p, name: g, desktop: f, links: f }))) != null ? e : [];
  ...
  let r = a.filter(({ injected: o }) => !!o.some((l) => C.client().safeCheckInjectedProvider(l.injected_id) && l.namespace === e));
  return r.length > 1 && (r = r.filter(({ injected: o }) => !!o.map(({ injected_id: l }) => l).every((l) => l !== "isMetaMask"))), r.length ? r : [{ name: "Browser", id: "browser", image_id: void 0 }];
}, injectedWallets() {
  const { isStandalone: t } = d.state, { explorerExcludedWalletIds: e, explorerRecommendedWalletIds: a } = y.state, r = c.isMobile();
  if (t || e === "ALL" || r)
    return [];
  const { namespace: o } = C.client(), { injectedWallets: l } = ne.state;
  return l.filter(({ id: i, injected: p }) => {
    const g = c.isArray(e) ? e : [], f = c.isArray(a) ? a : [];
  ...
  var e;
  const a = Z.installedInjectedWallets().map(({ id: i }) => i), r = t || (e = Z.recentWallet()) == null ? void 0 : e.id, o = [...a, r], { recomendedWallets: l } = ne.state;
...
var s = { MOBILE_BREAKPOINT: 600, W3M_RECENT_WALLET_DATA: "W3M_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", rejectStandaloneButtonComponent() {
  ...
  var e;
  const a = Io[t], { projectId: r, chainImages: o } = y.state;
  return (e = o == null ? void 0 : o[t]) != null ? e : r && a ? ne.getAssetImageUrl(a) : "";
}, getTokenIcon(t) {
  var e, a;
  const r = (e = Eo[t]) == null ? void 0 : e.icon, { projectId: o, tokenImages: l } = y.state;
  return (a = l == null ? void 0 : l[t]) != null ? a : o && r ? ne.getAssetImageUrl(r) : "";
}, isMobileAnimation() {
  ...
  const { standaloneUri: e } = d.state, { pairingUri: a } = _.state, { mobile: r, name: o } = t, l = r == null ? void 0 : r.native, i = r == null ? void 0 : r.universal;
  s.setRecentWallet(t);
  function p(g) {
    let f = "";
    l ? f = c.formatUniversalUrl(l, g, o) : i && (f = c.formatNativeUrl(i, g, o)), c.openHref(f, "_self");
  }
  p(e || a);
  ...
  const { chainImages: t, walletImages: e } = y.state, a = Object.values(t != null ? t : {}), r = Object.values(e != null ? e : {});
  ...
  a == null ? void 0 : a.forEach((l) => {
    let i = 0;
    for (let g = 0; g < l.length; g += 1)
      i = l.charCodeAt(g) + ((i << 5) - i), i = i & i;
    const p = [0, 0, 0];
    for (let g = 0; g < 3; g += 1) {
      const f = i >> g * 8 & 255;
      p[g] = f;
  ...
  const { id: t, desktop: e, mobile: a, injected: r } = c.getWalletRouterData(), o = Z.installedInjectedWallets(), l = !!(r != null && r.length), i = o.some((j) => j.id === t), p = !!(e != null && e.native), g = !!(e != null && e.universal), f = !!(a != null && a.native) || !!(a != null && a.universal);
  return { isInjectedInstalled: i, isInjected: l, isDesktop: p, isMobile: f, isWeb: g };
}, goToConnectingView(t) {
  b.setData({ Wallet: t });
  const e = c.isMobile(), { isDesktop: a, isWeb: r, isMobile: o, isInjectedInstalled: l } = s.getCachedRouterWalletPlatforms();
  e ? l ? b.push("InjectedConnecting") : o ? b.push("MobileConnecting") : r ? b.push("WebConnecting") : b.push("InstallWallet") : l ? b.push("InjectedConnecting") : a ? b.push("DesktopConnecting") : r ? b.push("WebConnecting") : o ? b.push("MobileQrcodeConnecting") : b.push("InstallWallet");
} };
var Wo = css`.w3m-router{overflow:hidden;will-change:transform}.w3m-content{display:flex;flex-direction:column}`;
var Ao = Object.defineProperty;
var jo = Object.getOwnPropertyDescriptor;
var Xt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? jo(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
ft.styles = [w.globalCss, Wo], Xt([state()], ft.prototype, "view", 2), Xt([state()], ft.prototype, "prevView", 2), ft = Xt([customElement("w3m-modal-router")], ft);
var Mo = css`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--w3m-notification-border-radius);border:1px solid var(--w3m-color-overlay);background-color:var(--w3m-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--w3m-color-bg-3)}}.w3m-success path{fill:var(--w3m-accent-color)}.w3m-error path{fill:var(--w3m-error-color)}`;
var Po = Object.defineProperty;
var To = Object.getOwnPropertyDescriptor;
var Ee = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? To(e, a) : e, l = t.length - 1, i; l >= 0; l--)
...
var Bo = { generate(t, e, a, r) {
  const o = r === "light" ? "#141414" : "#fff", l = r === "light" ? "#fff" : "#141414", i = [], p = So(t, "Q"), g = e / p.length, f = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  f.forEach(({ x: W, y: k }) => {
    const N = (p.length - U) * g * W, I = (p.length - U) * g * k, D = 0.32;
    for (let S = 0; S < f.length; S += 1) {
      const lt = g * (U - S * 2);
      i.push(svg`<rect fill="${S % 2 === 0 ? o : l}" height="${lt}" rx="${lt * D}" ry="${lt * D}" width="${lt}" x="${N + g * S}" y="${I + g * S}">`);
    }
  });
  ...
  return Ce.forEach(([W, k]) => {
    ...
    k.forEach((N) => {
      i.push(svg`<circle cx="${W}" cy="${N}" fill="${o}" r="${g / Ae}">`);
    });
...
var G = class extends LitElement {
  ...
  svgTemplate() {
    ...
    return svg`<svg height="${this.size}" width="${this.size}">${Bo.generate(this.uri, this.size, this.size / 4, e)}</svg>`;
  }
  render() {
    return html`<div>${this.walletId || this.imageUrl ? html`<w3m-wallet-image walletId="${this.walletId}" imageId="${this.imageId}" imageUrl="${this.imageUrl}"></w3m-wallet-image>` : h.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}<w3m-theme-context></w3m-theme-context></div>`;
  }
};
G.styles = [w.globalCss, Uo], st([property()], G.prototype, "uri", 2), st([property({ type: Number })], G.prototype, "size", 2), st([property()], G.prototype, "imageId", 2), st([property()], G.prototype, "walletId", 2), st([property()], G.prototype, "imageUrl", 2), G = st([customElement("w3m-qrcode")], G);
var Go = css`:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--w3m-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--w3m-color-fg-1);background-color:var(--w3m-color-bg-3);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);caret-color:var(--w3m-accent-color)}input::placeholder{color:var(--w3m-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--w3m-accent-color)}path{fill:var(--w3m-color-fg-2)}`;
var Fo = Object.defineProperty;
var qo = Object.getOwnPropertyDescriptor;
var je = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? qo(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var _t = class extends LitElement {
  ...
  render() {
    return html`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${h.SEARCH_ICON}`;
  }
};
_t.styles = [w.globalCss, Go], je([property()], _t.prototype, "onChange", 2), _t = je([customElement("w3m-search-input")], _t);
var Ko = css`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--w3m-accent-color)}`;
...
var Nt = class extends LitElement {
  ...
  render() {
    ...
    return e ? html`<div><img src="${e}" alt="${this.id}"></div>` : h.TOKEN_PLACEHOLDER;
  }
};
Nt.styles = [w.globalCss, oa], Me([property()], Nt.prototype, "symbol", 2), Nt = Me([customElement("w3m-token-image")], Nt);
...
var F = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? na(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var ct = class extends LitElement {
  ...
  render() {
    ...
    return html`${e.length ? html`<div><img src="${e}" alt="${this.id}"></div>` : h.WALLET_PLACEHOLDER}`;
  }
};
ct.styles = [w.globalCss, sa], Rt([property()], ct.prototype, "walletId", 2), Rt([property()], ct.prototype, "imageId", 2), Rt([property()], ct.prototype, "imageUrl", 2), ct = Rt([customElement("w3m-wallet-image")], ct);
var ma = Object.defineProperty;
var ha = Object.getOwnPropertyDescriptor;
var pa = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ha(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
Pe = pa([customElement("w3m-account-context")], Pe);
var wa = Object.defineProperty;
var ga = Object.getOwnPropertyDescriptor;
var Te = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ga(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var oe2 = class extends LitElement {
  ...
  async preloadListings() {
    ...
    if (y.state.enableExplorer) {
      ...
      const { recomendedWallets: a } = ne.state, r = Z.installedInjectedWallets(), o = (t = e == null ? void 0 : e.map((p) => s.getChainIcon(p.id))) != null ? t : [], l = a.map((p) => s.getWalletIcon(p)), i = r.map((p) => s.getWalletIcon(p));
...
var Le = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? va(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var xa = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? fa(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
_e = xa([customElement("w3m-theme-context")], _e);
var ya = Object.defineProperty;
var Ca = Object.getOwnPropertyDescriptor;
var $a = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Ca(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Re = class extends LitElement {
  constructor() {
    super(), this.unwatchOptions = void 0, this.unwatchAccount = void 0, this.timeout = void 0, this.isGenerated = false, this.selectedChainId = (Ne = d.state.selectedChain) == null ? void 0 : Ne.id, this.isAccountConnected = K.state.isConnected, this.lastRetry = Date.now(), this.unwatchOptions = d.subscribe((t) => {
      var e, a;
  ...
  async connectAndWait() {
    if (clearTimeout(this.timeout), !this.isAccountConnected) {
      ...
      try {
        ...
        console.error(t), _.setPairingError(true), oe.openToast("Connection request declined", "error"), Date.now() - this.lastRetry >= Oa && (this.lastRetry = Date.now(), this.connectAndWait());
      }
    }
  }
};
Re = $a([customElement("w3m-wc-connection-context")], Re);
...
var re = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Wa(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var le = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Ma(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var $t = class extends LitElement {
  ...
  render() {
    const { chains: t, selectedChain: e } = d.state, a = t == null ? void 0 : t.map((l) => l.id), r = e && (a == null ? void 0 : a.includes(e.id)), o = t && t.length <= 1 && r;
...
$t.styles = [w.globalCss, Aa], le([state()], $t.prototype, "chainId", 2), le([state()], $t.prototype, "label", 2), $t = le([customElement("w3m-account-network-button")], $t);
...
var kt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? La(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
  return r && o && Ta(e, a, o), o;
};
...
var ie = class extends LitElement {
  ...
  render() {
    const { recomendedWallets: t } = ne.state, e = [...t, ...t], a = P.externalWalletsTemplate(), r = P.installedInjectedWalletsTemplate(), o = [...r, ...a].length > 0, l = c.RECOMMENDED_WALLET_AMOUNT * 2;
    return html`<w3m-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${h.QRCODE_ICON}"></w3m-modal-header><w3m-modal-content><div class="w3m-title">${h.MOBILE_ICON}<w3m-text variant="small-regular" color="accent">WalletConnect</w3m-text></div><div class="w3m-slider"><div class="w3m-track">${[...Array(l)].map((i, p) => {
      const g = e[p % e.length];
      return g ? html`<w3m-wallet-image walletId="${g.id}" imageId="${g.image_id}"></w3m-wallet-image>` : h.WALLET_PLACEHOLDER;
    })}</div><w3m-button-big @click="${s.handleAndroidLinking}"><w3m-text variant="medium-regular" color="inverse">Select Wallet</w3m-text></w3m-button-big></div></w3m-modal-content>${o ? html`<w3m-modal-footer><div class="w3m-title">${h.WALLET_ICON}<w3m-text variant="small-regular" color="accent">Other</w3m-text></div><div class="w3m-grid">${r} ${a}</div></w3m-modal-footer>` : null}<w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Choose WalletConnect to see supported apps on your device${o ? ", or select from other options" : ""}`}</w3m-text><w3m-button variant="outline" .iconRight="${h.ARROW_UP_RIGHT_ICON}" .onClick="${() => this.onGetWallet()}">I don't have a wallet</w3m-button></w3m-info-footer>`;
  }
};
ie.styles = [w.globalCss, _a], ie = Da([customElement("w3m-android-wallet-selection")], ie);
...
var Ot = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Sa(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var It = class extends LitElement {
  ...
  render() {
    let t = "_._";
    return this.amount === "0.0" ? t = "0" : typeof this.amount == "string" && this.amount.length > 6 ? t = this.amount.substring(0, 6) : typeof this.amount == "string" && (t = this.amount), html`<div><w3m-token-image symbol="${this.symbol}"></w3m-token-image><w3m-text variant="medium-regular" color="primary">${t} ${this.symbol}</w3m-text></div>`;
  }
};
...
var mt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Ya(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var q = class extends LitElement {
  ...
  svgLoaderTemplate() {
    ...
    const o = 317 - r * 1.57, l = 425 - r * 1.8;
    return html`<svg viewBox="0 0 110 110" width="110" height="110"><rect id="w3m-loader" x="2" y="2" width="106" height="106" rx="${r}"/><use xlink:href="#w3m-loader" stroke-dasharray="106 ${o}" stroke-dashoffset="${l}"></use></svg>`;
  }
  render() {
...
var ht = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Xa(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var or = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? er(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
  return r && o && tr(e, a, o), o;
};
var se2 = class extends LitElement {
  render() {
    const { isStandalone: t } = d.state, { explorerExcludedWalletIds: e, enableExplorer: a } = y.state, r = e !== "ALL" && a, o = P.manualWalletsTemplate(), l = P.recomendedWalletsTemplate(), i = P.externalWalletsTemplate(), p = P.recentWalletTemplate(), g = P.installedInjectedWalletsTemplate();
    let f = [p, ...o, ...l];
...
var ir = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? lr(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var dr = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? cr(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var de = class extends LitElement {
  ...
  render() {
    ...
    j ? $ = f.slice(0, 7) : $ = f;
    const _2 = !!$.length;
    return html`<w3m-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${h.QRCODE_ICON}"></w3m-modal-header>${_2 ? html`<w3m-modal-content><div>${$} ${j ? html`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>` : null}</div></w3m-modal-content>` : null}`;
  }
};
...
var me = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? pr(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Zt = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ur(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Ht = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? fr(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var V = class extends LitElement {
  ...
  render() {
    const { isStandalone: t } = d.state;
    return html`<div>${this.isRetry ? html`<slot></slot>` : null} ${this.isMobile ? html`<w3m-button .onClick="${this.onMobile}" .iconLeft="${h.MOBILE_ICON}" variant="outline">Mobile</w3m-button>` : null} ${this.isInjected && !t ? html`<w3m-button .onClick="${this.onInjected}" .iconLeft="${h.WALLET_ICON}" variant="outline">Browser</w3m-button>` : null} ${this.isDesktop ? html`<w3m-button .onClick="${this.onDesktop}" .iconLeft="${h.DESKTOP_ICON}" variant="outline">Desktop</w3m-button>` : null} ${this.isWeb ? html`<w3m-button .onClick="${this.onWeb}" .iconLeft="${h.GLOBE_ICON}" variant="outline">Web</w3m-button>` : null}</div>`;
  }
};
...
var Ir = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Or(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var he = class extends LitElement {
  ...
  render() {
    ...
    return html`<button @click="${this.onClick}"><div class="w3m-icons">${a.map((r) => {
      ...
      return l ? html`<img src="${l}">` : h.WALLET_PLACEHOLDER;
...
var St = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Ar(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Nr = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? _r(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var De = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Zr(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Bt = class extends LitElement {
  ...
  render() {
    const { name: t, id: e, image_id: a } = c.getWalletRouterData(), { isMobile: r, isInjected: o, isWeb: l } = s.getCachedRouterWalletPlatforms();
    return html`<w3m-modal-header title="${t}" .onAction="${s.handleUriCopy}" .actionIcon="${h.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${e}" imageId="${a}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Connection can continue loading if ${t} is not installed on your device`}</w3m-text><w3m-platform-selection .isMobile="${r}" .isInjected="${o}" .isWeb="${l}" .isRetry="${true}"><w3m-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${h.RETRY_ICON}">Retry</w3m-button></w3m-platform-selection></w3m-info-footer>`;
  }
};
Bt.styles = [w.globalCss, Rr], De([state()], Bt.prototype, "isError", 2), Bt = De([customElement("w3m-desktop-connecting-view")], Bt);
...
var Ur = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Br(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
  return r && o && Sr(e, a, o), o;
};
...
var Fr = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Gr(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Ze = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Yr(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
  return r && o && Kr(e, a, o), o;
};
var Ut = class extends LitElement {
  ...
  render() {
    const { name: t, id: e, image_id: a } = c.getWalletRouterData(), { isMobile: r, isDesktop: o, isWeb: l } = s.getCachedRouterWalletPlatforms();
    return html`<w3m-modal-header title="${t}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${e}" imageId="${a}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">Connection can be declined if multiple wallets are installed or previous request is still active</w3m-text><w3m-platform-selection .isMobile="${r}" .isDesktop="${o}" .isWeb="${l}" .isRetry="${true}"><w3m-button .onClick="${this.openInjectedApp.bind(this)}" .disabled="${!this.isError}" .iconRight="${h.RETRY_ICON}">Retry</w3m-button></w3m-platform-selection></w3m-info-footer>`;
  }
};
Ut.styles = [w.globalCss, qr], Ze([state()], Ut.prototype, "isError", 2), Ut = Ze([customElement("w3m-injected-connecting-view")], Ut);
...
var tl = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? Jr(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Vt = class extends LitElement {
  ...
  onFormatAndRedirect(t, e = false) {
    const { mobile: a, name: r } = c.getWalletRouterData(), o = a == null ? void 0 : a.native, l = a == null ? void 0 : a.universal;
    if (o && !e) {
      const i = c.formatNativeUrl(o, t, r);
      c.openHref(i, "_self");
    } else if (l) {
      const i = c.formatUniversalUrl(l, t, r);
      c.openHref(i, "_self");
    }
  }
  ...
  render() {
    const { name: t, id: e, image_id: a, app: r, mobile: o } = c.getWalletRouterData(), { isWeb: l } = s.getCachedRouterWalletPlatforms(), i = r == null ? void 0 : r.ios, p = o == null ? void 0 : o.universal;
    return html`<w3m-modal-header title="${t}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${e}" imageId="${a}" label="Tap 'Open' to continue…" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer class="w3m-note"><w3m-platform-selection .isWeb="${l}" .isRetry="${true}"><w3m-button .onClick="${() => this.openMobileApp(false)}" .iconRight="${h.RETRY_ICON}">Retry</w3m-button></w3m-platform-selection>${p ? html`<w3m-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(true)}">Try this alternate link</span></w3m-text>` : null}</w3m-info-footer><w3m-info-footer class="w3m-app-store"><div><w3m-wallet-image walletId="${e}" imageId="${a}"></w3m-wallet-image><w3m-text>${`Get ${t}`}</w3m-text></div><w3m-button .iconRight="${h.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(i)}" variant="ghost">App Store</w3m-button></w3m-info-footer>`;
  }
};
Vt.styles = [w.globalCss, el], He([state()], Vt.prototype, "isError", 2), Vt = He([customElement("w3m-mobile-connecting-view")], Vt);
var rl = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var ll = Object.defineProperty;
var il = Object.getOwnPropertyDescriptor;
var nl = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? il(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
  return r && o && ll(e, a, o), o;
};
var be = class extends LitElement {
  render() {
    const { name: t, id: e, image_id: a } = c.getWalletRouterData(), { isInjected: r, isDesktop: o, isWeb: l } = s.getCachedRouterWalletPlatforms();
    return html`<w3m-modal-header title="${t}" .onAction="${s.handleUriCopy}" .actionIcon="${h.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-walletconnect-qr walletId="${e}" imageId="${a}"></w3m-walletconnect-qr></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${t} app`}</w3m-text><w3m-platform-selection .isDesktop="${o}" .isInjected="${r}" .isWeb="${l}"></w3m-platform-selection></w3m-info-footer>`;
  }
};
be.styles = [w.globalCss, rl], be = nl([customElement("w3m-mobile-qr-connecting-view")], be);
var sl = Object.defineProperty;
var cl = Object.getOwnPropertyDescriptor;
var dl = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? cl(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
  return r && o && sl(e, a, o), o;
};
var fe = class extends LitElement {
  render() {
    return html`<w3m-modal-header title="Scan the code" .onAction="${s.handleUriCopy}" .actionIcon="${h.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-walletconnect-qr></w3m-walletconnect-qr></w3m-modal-content>`;
  }
};
fe.styles = [w.globalCss], fe = dl([customElement("w3m-qrcode-view")], fe);
var ml = css`div{display:grid;grid-template-columns:repeat(4,80px);margin:-5px -10px;justify-content:space-between}w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-info-footer w3m-text{text-align:center}`;
var ze = Object.defineProperty;
var hl = Object.defineProperties;
...
var Be = (t, e, a) => e in t ? ze(t, e, { enumerable: true, configurable: true, writable: true, value: a }) : t[e] = a;
var vl = (t, e) => {
  for (var a in e || (e = {}))
    gl.call(e, a) && Be(t, a, e[a]);
  if (Se)
    for (var a of Se(e))
      ul.call(e, a) && Be(t, a, e[a]);
  return t;
};
var bl = (t, e) => hl(t, wl(e));
var xe = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? pl(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Wt = class extends LitElement {
  ...
  async onSelectChain(t) {
    try {
      ...
      console.error(e), oe.openToast("Unsupported chain", "error");
    }
  }
  ...
  render() {
    const { chains: t } = d.state, e = t == null ? void 0 : t.map((r) => bl(vl({}, r), { unsupported: this.isUnsuportedChainId(r.id) })), a = e == null ? void 0 : e.sort((r, o) => Number(r.unsupported) - Number(o.unsupported));
...
Wt.styles = [w.globalCss, ml], xe([state()], Wt.prototype, "connectedChains", 2), xe([state()], Wt.prototype, "isUnsupportedChains", 2), Wt = xe([customElement("w3m-select-network-view")], Wt);
var fl = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}w3m-button{margin-top:15px}`;
var xl = Object.defineProperty;
var yl = Object.getOwnPropertyDescriptor;
var Ue = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? yl(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var ot = class extends LitElement {
  ...
  async fetchWallets() {
    var t;
    const { wallets: e, search: a, injectedWallets: r } = ne.state, { listings: o, total: l, page: i } = this.search ? a : e;
    if (!this.endReached && (this.firstFetch || l > ye && o.length < l))
      try {
        this.loading = true;
        const p = (t = d.state.standaloneChains) == null ? void 0 : t.join(","), { listings: g } = await ne.getWallets({ page: this.firstFetch ? 1 : i + 1, entries: ye, search: this.search, version: d.state.walletConnectVersion, chains: p }), f = g.map(($) => s.getWalletIcon($)), j = r.map(($) => s.getWalletIcon($));
  ...
  render() {
    ...
    let l = P.injectedWalletsTemplate(), i = P.manualWalletsTemplate(), p = P.recomendedWalletsTemplate(true);
    o && (l = l.filter(({ values: $ }) => s.caseSafeIncludes($[0], this.search)), i = i.filter(({ values: $ }) => s.caseSafeIncludes($[0], this.search)), p = p.filter(({ values: $ }) => s.caseSafeIncludes($[0], this.search)));
    ...
    return html`<w3m-modal-header><w3m-search-input .onChange="${this.onSearchChange.bind(this)}"></w3m-search-input></w3m-modal-header><w3m-modal-content class="${classMap(j)}"><div class="w3m-grid">${r ? null : p} ${r ? null : [...Array(f)].map(($, _2) => html`${i[_2]} ${l[_2]} ${a[_2] ? html`<w3m-wallet-button imageId="${a[_2].image_id}" name="${a[_2].name}" walletId="${a[_2].id}" .onClick="${() => this.onConnect(a[_2])}"></w3m-wallet-button>` : null}`)}</div><div class="w3m-placeholder-block">${g ? html`<w3m-text variant="big-bold" color="secondary">No results found</w3m-text>` : null} ${!g && this.loading ? html`<w3m-spinner></w3m-spinner>` : null}</div></w3m-modal-content>`;
  }
};
ot.styles = [w.globalCss, Cl], At([state()], ot.prototype, "loading", 2), At([state()], ot.prototype, "firstFetch", 2), At([state()], ot.prototype, "search", 2), At([state()], ot.prototype, "endReached", 2), ot = At([customElement("w3m-wallet-explorer-view")], ot);
var Ol = css`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var Il = Object.defineProperty;
var El = Object.getOwnPropertyDescriptor;
var Ve = (t, e, a, r) => {
  for (var o = r > 1 ? void 0 : r ? El(e, a) : e, l = t.length - 1, i; l >= 0; l--)
    (i = t[l]) && (o = (r ? i(e, a, o) : i(o)) || o);
...
var Gt = class extends LitElement {
  ...
  render() {
    const { name: t, id: e, image_id: a } = c.getWalletRouterData(), { isMobile: r, isInjected: o, isDesktop: l } = s.getCachedRouterWalletPlatforms(), i = c.isMobile();
    return html`<w3m-modal-header title="${t}" .onAction="${s.handleUriCopy}" .actionIcon="${h.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${e}" imageId="${a}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`${t} web app has opened in a new tab. Go there, accept the connection, and come back`}</w3m-text><w3m-platform-selection .isMobile="${r}" .isInjected="${i ? false : o}" .isDesktop="${i ? false : l}" .isRetry="${true}"><w3m-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${h.RETRY_ICON}">Retry</w3m-button></w3m-platform-selection></w3m-info-footer>`;
  }
};
Gt.styles = [w.globalCss, Ol], Ve([state()], Gt.prototype, "isError", 2), Gt = Ve([customElement("w3m-web-connecting-view")], Gt);
export {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=index.es-SUC5DJU2.js.map
