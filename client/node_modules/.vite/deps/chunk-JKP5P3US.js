...
var SmartWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-U5ZQ4R74.js");
...
var CoinbaseWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-3X4FTAYQ.js");
...
var LocalWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-OW7RUNUR.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-4PBJ5U2L.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect-v1.browser.esm-HGLRTLTW.js");
...
var WalletConnect2 = class extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-AKPI2RGP.js");
...
var SafeWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-VNNMF3SB.js");
...
//# sourceMappingURL=chunk-JKP5P3US.js.map
