import {
  ...
  useWallet,
  useWalletContext
} from "./chunk-ELPRHYWQ.js";
import {
  CoinbaseWallet,
  MetaMaskWallet,
  WalletConnectV1
} from "./chunk-3SPPP4RN.js";
import {
...
import {
  walletIds
} from "./chunk-753PK2LW.js";
import {
  require_prop_types
} from "./chunk-3VR6UO4I.js";
import {
  require_jsx_runtime
  ...
  "node_modules/react-qr-code/lib/QRCodeSvg/index.js"(exports) {
    ...
    var QRCodeSvg = (0, _react.forwardRef)(function(_ref, ref) {
      ...
      return _react2.default.createElement(
        "svg",
        _extends2({}, props, { height: size, ref, viewBox: "0 0 " + viewBoxSize + " " + viewBoxSize, width: size }),
...
var require_lib = __commonJS({
  "node_modules/react-qr-code/lib/index.js"(exports) {
    ...
    var QRCode2 = (0, _react.forwardRef)(function(_ref, ref) {
      ...
      return _react2.default.createElement(_QRCodeSvg2.default, _extends2({}, props, {
        bgColor,
...
// node_modules/@thirdweb-dev/react/dist/headlessConnectUI-d7ab9645.browser.esm.js
init_shim();
...
var ModalTitle = newStyled($5d3850c4d0b4e6c7$export$f99233281efd08a0)`
  margin: 0;
  font-weight: 600;
...
function detectOS() {
  ...
  return (env2 == null ? void 0 : env2.os) ? env2.os : void 0;
}
function isMobile() {
  const os = detectOS();
...
var SkeletonDiv = newStyled.div`
  ...
  --skeleton-c-1: ${(p) => {
  var _a;
  return p.theme.bg[((_a = p.gradient) == null ? void 0 : _a.c1) || "elevated"];
}};
  --skeleton-c-2: ${(p) => {
  var _a;
  return p.theme.bg[((_a = p.gradient) == null ? void 0 : _a.c2) || "highlighted"];
}};
...
var QRCode = (props) => {
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [props.qrCodeUri ? (0, import_jsx_runtime.jsx)(FadeIn, {
      children: (0, import_jsx_runtime.jsx)(QRCodeContainer, {
        children: (0, import_jsx_runtime.jsx)(StyledReactQrCode, {
          value: props.qrCodeUri
        })
      })
    }) : (0, import_jsx_runtime.jsx)(QRSkeleton, {
      height: "200px",
      width: "200px"
    }), props.QRIcon && (0, import_jsx_runtime.jsx)(QrCodeIconContainer, {
      children: props.QRIcon
    })]
  });
};
var QrCodeIconContainer = newStyled.div`
  position: absolute;
  top: 50%;
  left: 50%;
...
`;
var StyledReactQrCode = newStyled(import_react_qr_code.default)`
  width: 200px;
  height: 200px;
  border-radius: ${radius.md};
...
`;
var QRSkeleton = newStyled(Skeleton)`
  width: 200px;
  height: 200px;
  border-radius: ${radius.md};
  ${media.mobile} {
...
`;
var Apple = "ipfs://Qmcyb1akWqyu8W4DgVWzZUozrCkfES8ow36jNhjs7arwvc/AppleGray.svg";
var Chrome = "ipfs://QmPu4UKsektZixeZN4ixi8Ji9KbMuwcRKAp3JRK4jrcaMK/Chrome.svg";
var GooglePlay = "ipfs://QmTSu87iXWpfcCgy15DX3Mgp1Rqb8zFAwXdbLNh6WxmpC4/GooglePlay.svg";
var GetStartedScreen = (props) => {
  const [showScreen, setShowScreen] = (0, import_react18.useState)("base");
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [(0, import_jsx_runtime.jsx)(BackButton, {
    ...
    }), showScreen === "android-scan" && props.googlePlayStoreLink && (0, import_jsx_runtime.jsx)(ScanScreen$1, {
      platformIcon: (0, import_jsx_runtime.jsx)(Img, {
        src: GooglePlay,
        width: iconSize.md,
        height: iconSize.md
      }),
    ...
    }), showScreen === "ios-scan" && props.appleStoreLink && (0, import_jsx_runtime.jsx)(ScanScreen$1, {
      platformIcon: (0, import_jsx_runtime.jsx)(Img, {
        width: iconSize.md,
        height: iconSize.md,
        src: Apple
      ...
      children: [(0, import_jsx_runtime.jsx)(Spacer, {
        y: "lg"
      }), props.header || (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [(0, import_jsx_runtime.jsx)(Img, {
          src: props.walletIconURL,
          width: iconSize.xl,
          height: iconSize.xl,
        ...
        gap: "xs",
        children: [props.chromeExtensionLink && (0, import_jsx_runtime.jsxs)(ButtonLink, {
          onClick: () => {
        ...
        }), props.googlePlayStoreLink && (0, import_jsx_runtime.jsxs)(ButtonLink, {
          as: "button",
          onClick: () => {
            if (isMobile()) {
        ...
        }), props.appleStoreLink && (0, import_jsx_runtime.jsxs)(ButtonLink, {
          as: "button",
          onClick: () => {
            if (isMobile()) {
    ...
    }), isScanScreen && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [(0, import_jsx_runtime.jsx)(Spacer, {
        y: "xl"
      }), (0, import_jsx_runtime.jsxs)(HelperLink, {
        as: "button",
...
var ScanScreen$1 = (props) => {
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime.jsx)(QRCode, {
      ...
      children: [props.platformIcon, (0, import_jsx_runtime.jsxs)(ModalTitle, {
        children: ["Install ", props.walletName, " on ", props.platform]
      })]
    }), (0, import_jsx_runtime.jsx)(Spacer, {
      y: "lg"
    }), (0, import_jsx_runtime.jsxs)(ModalDescription, {
      children: ["Scan QR with your phone to download ", (0, import_jsx_runtime.jsx)("br", {}), " ", props.walletName, " for", " ", props.platform]
    })]
  });
};
...
var ScanScreen = (props) => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [!props.hideBackButton && (0, import_jsx_runtime.jsx)(BackButton, {
      onClick: props.onBack,
      style: {
        position: "absolute",
        zIndex: 10,
      ...
      children: [(0, import_jsx_runtime.jsx)(QRCode, {
        ...
        children: ["Scan this QR code with your phone ", (0, import_jsx_runtime.jsx)("br", {}), "camera or ", walletName, " to connect"]
      }), (0, import_jsx_runtime.jsx)(Spacer, {
        y: "md"
        ...
        y: "xl"
      }), (0, import_jsx_runtime.jsxs)(LinkButton, {
...
var CoinbaseScan = (_ref) => {
  ...
  const [qrCodeUri, setQrCodeUri] = (0, import_react18.useState)(void 0);
  const {
    setConnectedWallet,
    chainToConnect,
    setConnectionStatus
...
var CoinbaseConnectUI = (_ref) => {
  ...
  const [screen, setScreen] = (0, import_react18.useState)("loading");
  ...
  return {
    ...
    isInstalled() {
      ...
      if (assertWindowEthereum(globalThis.window)) {
        return ((_a = globalThis.window.ethereum) == null ? void 0 : _a.isCoinbaseWallet) || ((_c = (_b = globalThis.window.ethereum) == null ? void 0 : _b.providers) == null ? void 0 : _c.some((p) => p.isCoinbaseWallet)) || false;
      }
      return false;
    }
  };
...
var walletConnectV1$1 = Object.freeze({
  __proto__: null,
  walletConnectV1
});
var defaultWallets = [metamaskWallet(), coinbaseWallet(), walletConnectV1()];
var WalletModalOpen = (0, import_react18.createContext)(false);
var SetWalletModalOpen = (0, import_react18.createContext)(void 0);
var ModalConfigCtx = (0, import_react18.createContext)({
  title: "",
  theme: "dark",
  data: void 0
});
var SetModalConfigCtx = (0, import_react18.createContext)(() => {
});
var WalletUIStatesProvider = (props) => {
  const [isWalletModalOpen, setIsWalletModalOpen] = (0, import_react18.useState)(false);
  const [modalConfig, setModalConfig] = (0, import_react18.useState)({
    title: "Choose your wallet",
    theme: props.theme || "dark",
    data: void 0
  });
  return (0, import_jsx_runtime.jsx)(WalletModalOpen.Provider, {
    value: isWalletModalOpen,
    children: (0, import_jsx_runtime.jsx)(SetWalletModalOpen.Provider, {
      value: setIsWalletModalOpen,
      children: (0, import_jsx_runtime.jsx)(ModalConfigCtx.Provider, {
        value: modalConfig,
        children: (0, import_jsx_runtime.jsx)(SetModalConfigCtx.Provider, {
...
var useIsWalletModalOpen = () => {
  return (0, import_react18.useContext)(WalletModalOpen);
};
var useSetIsWalletModalOpen = () => {
  const context = (0, import_react18.useContext)(SetWalletModalOpen);
  if (context === void 0) {
...
var WalletSelector = (props) => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    ...
    }), localWalletInfo && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [(0, import_jsx_runtime.jsx)(Spacer, {
        y: "xl"
    ...
    }), showGetStarted && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [(0, import_jsx_runtime.jsx)(Spacer, {
        y: "xl"
...
var WalletSelection = (props) => {
  const modalConfig = (0, import_react18.useContext)(ModalConfigCtx);
  const setModalConfig = (0, import_react18.useContext)(SetModalConfigCtx);
    ...
    children: walletConfigs.map((walletConfig) => {
      ...
      return (0, import_jsx_runtime.jsx)("li", {
        children: walletConfig.selectUI ? (0, import_jsx_runtime.jsx)(walletConfig.selectUI, {
          ...
          walletConfig
        }) : (0, import_jsx_runtime.jsxs)(WalletButton, {
          type: "button",
          onClick: () => {
            props.selectWallet(walletConfig);
          },
          children: [(0, import_jsx_runtime.jsx)(Img, {
            ...
            height: iconSize.lg,
            loading: "eager"
          }), (0, import_jsx_runtime.jsx)(WalletName, {
            children: walletConfig.meta.name
          }), isInstalled && (0, import_jsx_runtime.jsx)(InstallBadge, {
            children: " Installed "
          })]
        })
      }, walletConfig.id);
...
`;
var InstallBadge = newStyled.span`
...
var HeadlessConnectUI = (_ref) => {
  ...
  const connect = useConnect();
  const prompted = (0, import_react18.useRef)(false);
...
//# sourceMappingURL=chunk-O4PZCP57.js.map
