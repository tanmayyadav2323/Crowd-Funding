    ...
    try {
      ...
      if (!targetChainId) {
        ...
        if (lastUsedChainId && !this.isChainUnsupported(lastUsedChainId)) {
          ...
          targetChainId = (_a = this.chains[0]) == null ? void 0 : _a.chainId;
        }
      }
      if (!targetChainId) {
      ...
      if (!isChainApproved && namespaceMethods.includes(ADD_ETH_CHAIN_METHOD)) {
        await provider.request({
          ...
          params: [{
            ...
            blockExplorerUrls: [((_a = chain.explorers) == null ? void 0 : _a.length) ? chain.explorers[0] : void 0],
...
async function _initProvider2() {
  const {
    ...
    OPTIONAL_EVENTS,
    OPTIONAL_METHODS
  } = await import("./index.es-LVUWW677.js");
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-X4BI5ILD.js.map
