...
// node_modules/@thirdweb-dev/wallets/dist/index-42b0f5f5.browser.esm.js
var import_legacy_modal = __toESM(require_cjs3());
init_esm5();
init_esm6();
var SignerConnection = class extends IJsonRpcConnection {
  constructor(opts) {
    ...
    this.opts = opts;
    this.chainId = (opts == null ? void 0 : opts.chainId) || this.chainId;
  ...
  register(opts) {
    ...
    this.bridge = (opts == null ? void 0 : opts.connector) ? opts.connector.bridge : (opts == null ? void 0 : opts.bridge) || "https://bridge.walletconnect.org";
    this.qrcode = typeof (opts == null ? void 0 : opts.qrcode) === "undefined" || opts.qrcode !== false;
    this.chainId = typeof (opts == null ? void 0 : opts.chainId) !== "undefined" ? opts.chainId : this.chainId;
    this.qrcodeModalOptions = opts == null ? void 0 : opts.qrcodeModalOptions;
    const connectorOpts = {
      bridge: this.bridge,
      qrcodeModal: this.qrcode ? import_legacy_modal.default : void 0,
      qrcodeModalOptions: this.qrcodeModalOptions,
      storageId: opts == null ? void 0 : opts.storageId,
      signingMethods: opts == null ? void 0 : opts.signingMethods,
      clientMeta: opts == null ? void 0 : opts.clientMeta,
      session: opts == null ? void 0 : opts.session
    };
    this.wc = typeof (opts == null ? void 0 : opts.connector) !== "undefined" ? opts.connector : new esm_default(connectorOpts);
    if (typeof this.wc === "undefined") {
  ...
  registerConnectorEvents() {
    ...
    this.wc.on("connect", (err) => {
      ...
      this.accounts = ((_a = this.wc) == null ? void 0 : _a.accounts) || [];
      this.chainId = ((_b = this.wc) == null ? void 0 : _b.chainId) || this.chainId;
      this.onOpen();
    });
...
var WalletConnectProvider = class {
  constructor(opts) {
    ...
    this.rpc = {
      infuraId: opts == null ? void 0 : opts.infuraId,
      custom: opts == null ? void 0 : opts.rpc
    };
    this.signer = new JsonRpcProvider(new SignerConnection$1(opts));
    const chainId = this.signer.connection.chainId || (opts == null ? void 0 : opts.chainId) || 1;
  ...
  get rpcUrl() {
    var _a;
    return ((_a = this.http) == null ? void 0 : _a.connection).url || "";
  }
  async request(args) {
    switch (args.method) {
...
//# sourceMappingURL=index-42b0f5f5.browser.esm-2IVMRXE6.js.map
