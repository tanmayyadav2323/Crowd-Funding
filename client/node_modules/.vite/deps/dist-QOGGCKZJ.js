  ...
  "node_modules/@coinbase/wallet-sdk/dist/vendor-js/eth-eip712-util/util.js"(exports, module) {
    ...
    function toBuffer(v) {
      if (!import_buffer.Buffer.isBuffer(v)) {
        if (Array.isArray(v)) {
          v = import_buffer.Buffer.from(v);
        } else if (typeof v === "string") {
          if (isHexString(v)) {
            v = import_buffer.Buffer.from(padToEven(stripHexPrefix(v)), "hex");
          } else {
            v = import_buffer.Buffer.from(v);
          }
          ...
          v = v.toArrayLike(import_buffer.Buffer);
        } else if (v.toArray) {
          v = import_buffer.Buffer.from(v.toArray());
        } else {
    ...
    var FilterPolyfill = class {
      ...
      async getBlockFilterChanges(id) {
        ...
        const blocks = (await Promise.all(
          (0, util_1.range)(cursorPosition, currentBlockHeight + 1).map((i) => this.getBlockHashByNumber((0, types_1.IntNumber)(i)))
        )).filter((hash) => !!hash);
  ...
  if (typeof resultSelector === "function") {
    return function(source) {
      return source.pipe(mergeMap(function(a, i) {
        return from(project(a, i)).pipe(map2(function(b, ii) {
...
function max2(comparer) {
  var max3 = typeof comparer === "function" ? function(x, y) {
...
function min2(comparer) {
  var min3 = typeof comparer === "function" ? function(x, y) {
    return comparer(x, y) < 0 ? x : y;
  } : function(x, y) {
    return x < y ? x : y;
  };
    ...
    var WalletSDKConnection = class {
      constructor(sessionId, sessionKey, linkAPIUrl, diagnostic, WebSocketClass = WebSocket) {
        ...
        this.subscriptions.add(ws.connectionState$.pipe(
          ...
          (0, operators_1.catchError)((_) => (0, rxjs_1.of)(false))
      ...
      makeRequest(message, timeout2 = REQUEST_TIMEOUT) {
        ...
        return this.ws.incomingJSONData$.pipe((0, operators_1.timeoutWith)(timeout2, (0, rxjs_1.throwError)(new Error(`request ${reqId} timed out`))), (0, operators_1.filter)((m) => m.id === reqId), (0, operators_1.take)(1));
      }
      authenticate() {
...
var require_CoinbaseWalletSDK = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletSDK.js"(exports) {
    ...
    var util_1 = require_util2();
    var LINK_API_URL = import_process.default.env.LINK_API_URL || "https://www.walletlink.org";
    var SDK_VERSION = import_process.default.env.SDK_VERSION || require_package().version || "unknown";
...
***************************************************************************** */
//# sourceMappingURL=dist-QOGGCKZJ.js.map
