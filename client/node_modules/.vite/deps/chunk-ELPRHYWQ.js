...
import {
  ...
  watchTransactions
} from "./chunk-NAP63STC.js";
import {
  ListingType
} from "./chunk-ON3U4TSX.js";
import {
  require_react_is
} from "./chunk-QM5JJFV7.js";
import {
  ThirdwebSDK,
  UserWallet,
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (import_process.default.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useState6 = React15.useState, useEffect7 = React15.useEffect, useLayoutEffect2 = React15.useLayoutEffect, useDebugValue = React15.useDebugValue;
...
init_shim();
var import_shim24 = __toESM(require_shim());
"use client";
var useSyncExternalStore = import_shim24.useSyncExternalStore;
...
// node_modules/@thirdweb-dev/react-core/dist/useTransactions-da2fbf4a.browser.esm.js
init_shim();
...
function resolveIpfsUri(uri, options) {
  ...
  const gatewayUrls = prepareGatewayUrls(parseGatewayUrls((options == null ? void 0 : options.gatewayUrl) ? [options == null ? void 0 : options.gatewayUrl] : void 0));
...
function ThirdwebWalletProvider(props) {
  ...
  const [connectionStatus, setConnectionStatus] = (0, import_react2.useState)("unknown");
  ...
  const theme = (0, import_react2.useContext)(ThirdwebThemeContext);
  ...
  const storeLastActiveChainId = (0, import_react2.useCallback)(async (chainId) => {
  ...
  const onWalletDisconnect = (0, import_react2.useCallback)(async () => {
...
async function doLogin(wallet, options) {
  let chainId = options == null ? void 0 : options.chainId;
  ...
  invariant(options == null ? void 0 : options.domain, "Please specify a domain to login with.");
  const nonce = (options == null ? void 0 : options.nonce) || Math.floor(Math.random() * 1e9).toString();
  const payloadData = {
    type: wallet.type,
    domain: options.domain,
    address: await wallet.getAddress(),
    statement: (options == null ? void 0 : options.statement) || "Please ensure that the domain above matches the URL of the current website.",
    version: (options == null ? void 0 : options.version) || "1",
    uri: options == null ? void 0 : options.uri,
    chain_id: chainId,
    nonce: (options == null ? void 0 : options.nonce) || nonce,
    issued_at: new Date().toISOString(),
    expiration_time: new Date((options == null ? void 0 : options.expirationTime) || Date.now() + 1e3 * 60 * 10).toISOString(),
    invalid_before: new Date((options == null ? void 0 : options.invalidBefore) || Date.now() - 1e3 * 60 * 10).toISOString(),
...
var ThirdwebAuthProvider = (_ref) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(ThirdwebAuthContext.Provider, {
    value: authContext,
    children: [children, (0, import_jsx_runtime2.jsx)(DisconnectOnAccountSwitch, {})]
  });
};
...
var updateChainRPCs = (chain, options) => {
  try {
    return {
      ...chain,
...
var DEFAULT_API_KEY = "fb52f0ca630bdd02f0d5210d9e8e3568272ac765dd0709272918eefb29d3ac9e";
var ThirdwebConfigContext = (0, import_react2.createContext)({
...
function useThirdwebConfigContext() {
  return (0, import_react2.useContext)(ThirdwebConfigContext);
}
...
var ThirdwebConnectedWalletContext = (0, import_react2.createContext)(INITIAL_CONTEXT_VALUE);
...
function useThirdwebConnectedWalletContext() {
  return (0, import_react2.useContext)(ThirdwebConnectedWalletContext);
}
...
function useSmartWallets(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.smartWalletFactory.getAll(contractAddress), () => {
    requiredParamInvariant(contract, "No Contract instance provided");
    invariant(contract.smartWalletFactory.getAllWallets, "Contract instance does not support contract.smartWalletFactory.getAllWallets");
...
function useIsSmartWalletDeployed(contract, admin, extraData) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.smartWalletFactory.getAll(contractAddress), () => {
    requiredParamInvariant(contract, "No Contract instance provided");
    invariant(contract.smartWalletFactory.isWalletDeployed, "Contract instance does not support contract.smartWalletFactory.getAllWallets");
...
var ThemeProvider = function ThemeProvider2(props) {
  ...
  return React12.createElement(ThemeContext.Provider, {
    value: theme
  }, props.children);
};
...
// node_modules/@thirdweb-dev/react/dist/basic-72632cb3.browser.esm.js
init_shim();
...
var Flex = (props) => {
  return (0, import_jsx_runtime4.jsxs)("div", {
    style: {
      ...
      gap: props.gap ? spacing[props.gap] : void 0,
      ...props.style || {}
    },
    children: [" ", props.children]
  });
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-ELPRHYWQ.js.map
