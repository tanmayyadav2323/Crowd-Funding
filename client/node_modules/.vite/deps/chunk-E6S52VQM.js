...
// node_modules/@thirdweb-dev/wallets/dist/smart-wallet-d213c48a.browser.esm.js
init_shim();
...
var SmartWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-U3LKUPZN.js");
...
var PaperWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-UJZEUKWO.js");
...
var CoinbaseWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-ZRXC7OHE.js");
...
var LocalWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-BQYP4WWA.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-XEVMEPNT.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect-v1.browser.esm-VPOXGJIO.js");
...
var WalletConnect2 = class extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-IURGG7MU.js");
...
var SafeWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-BL5X4HOO.js");
...
var MagicLink = class extends AbstractClientWallet {
  ...
  async initializeConnector() {
    const {
      MagicAuthConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-magic.browser.esm-O3RR2YDV.js");
...
var InjectedWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-HCF3GKH2.js");
...
//# sourceMappingURL=chunk-E6S52VQM.js.map
