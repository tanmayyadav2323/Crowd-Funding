...
var coinbaseWallet = require('./headlessConnectUI-77cf6566.cjs.prod.js');
...
const ConnectedWalletDetails = props => {
  ...
  const networkSwitcherButton = /*#__PURE__*/jsxRuntime.jsx(ToolTip, {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsxs(basic.Flex, {
      ...
      }), activeWalletConfig && activeWalletConfig.id === wallets.walletIds.metamask && activeWalletConfig.isInstalled && activeWalletConfig.isInstalled() && /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
        type: "button",
        onClick: () => {
      ...
      }), (chain?.faucets && chain.faucets.length > 0 || chain?.chainId === chains.Localhost.chainId) && /*#__PURE__*/jsxRuntime.jsxs(MenuLink, {
...
const SignatureModal = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Modal, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(Container, {
      children: [walletConfig && /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.Img, {
        height: basic.iconSize.xl,
...
const ConnectWallet = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(react.ThemeProvider, {
    ...
    }), requiresSignIn && /*#__PURE__*/jsxRuntime.jsxs(basic.Button, {
      variant: "inverted",
      onClick: signIn,
      "data-theme": theme,
...
function useResolvedMediaType(uri, mimeType, gatewayUrl) {
  ...
  const resolvedUrl = React.useMemo(() => reactCore.resolveIpfsUri(uri, gatewayUrl ? {
    gatewayUrl
  } : storage ? {
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-77cf6566.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-77cf6566.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-51e14ca2.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-77cf6566.cjs.prod.js'); }).then(function (n) { return n.walletConnectV1$1; });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./walletConnect-a37feeb8.cjs.prod.js'); });
