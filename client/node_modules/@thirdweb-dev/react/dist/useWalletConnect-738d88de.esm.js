...
import { I as Img, M as ModalTitle, a as ModalDescription, F as FormFieldWithIconButton, i as isMobile, h as fadeInAnimation, S as Skeleton, H as HelperLink, f as useSetIsWalletModalOpen, j as SetModalConfigCtx, u as useIsHeadlessWallet, G as GetStartedScreen, k as ModalConfigCtx, e as useIsWalletModalOpen, b as HeadlessConnectUI, l as WalletSelector, n as WalletUIStatesProvider, d as defaultWallets } from './headlessConnectUI-5af425b3.esm.js';
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./headlessConnectUI-5af425b3.esm.js').then(function (n) { return n.p; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./headlessConnectUI-5af425b3.esm.js').then(function (n) { return n.o; });
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./headlessConnectUI-5af425b3.esm.js').then(function (n) { return n.q; });
