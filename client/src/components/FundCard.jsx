...
const FundCard = ({ key, owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
    ...
    return (
        <div className="sm:w-[500px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
            ...
            <div className="flex flex-col p-4">
                ...
                <div className='flex items-center mt-[20px] gap-[12px] '>
                    ...
                    <p className="flex-1 font-epilogue font-normal text-[12px] text-[#808191] truncate">by <span className="text-[#b2b3bd]>by<span className='text-[#b2b3bd]">{owner}</span></p>
                </div>
            </div>
